...
//Variables vacias para llenar el formulario
$email = "";
$password = "";
$password_r = "";
$msg = "";
...
if( isset($_POST['email']) && isset($_POST['password']) && isset($_POST['password_r'])) {
  ...
  if ($password==$password_r){
    ...
    if ($count == 0){
      ...
      $msg.="<div class='alert alert-danger' role='alert'> El mail ingresado ya existe </div>";
    }

  }else{
    $msg = "<div class='alert alert-warning' role='alert'> Las claves no coinciden </div>";
  }

}else{

  $msg = "<div class='alert alert-warning' role='alert'> Complete el formulario </div>";
}
...
<!-- ############ LAYOUT START-->
  <div class="center-block w-xxl w-auto-xs p-y-md">
    ...
    <div class="p-a-md box-color r text-center box-shadow-z1 text-color m-a">
      ...
      <form method="post" target="register.php" name="form">
        ...
        <button type="submit" class="btn btn-primary btn-block p-x-md">Sign up</button>
      </form>
...
<br>
    <div class="p-v-lg text-center">
      <div>Already have an account? <a ui-sref="access.signin" href="login.php" class="xasd _600">Sign in</a></div>
    </div>
  </div>
