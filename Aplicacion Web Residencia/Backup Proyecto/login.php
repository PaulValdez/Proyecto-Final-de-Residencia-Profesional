...
if(isset($_POST['email']) && isset($_POST['password'])) {
  ...
  if ($_POST['email']==""){
    ...
    //   $msg .= "Exito!!!";
    $msg.= "<div class='alert alert-success p-3 mt-3 text-center mb-0 animate__animated animate__bounceInUp role='alert' >Exito!!!</div>";
    ...
    //   $msg .= "Acceso denegado!!!";
    $msg.= "<div class='alert alert-danger p-3 mt-3 text-center mb-0 animate__animated animate__tada' role='alert' >Acceso denegado!!!</div>";
      $_SESSION['logged'] = false;
    }
  }
}
  ...
  <div class="center-block w-xxl w-auto-xs p-y-md">
    ...
    <div class="p-a-md box-color r text-center box-shadow-z1 text-color m-a">
      ...
      <form target="" method="post" name="form">
        ...
        <button type="submit" class="btn btn-primary btn-block p-x-md" >Sign in</button>
      </form>
    ...
    <div class="p-v-lg text-center">
      <div>Do not have an account? <a ui-sref="access.signup" href="register.php" class=" xasd _600">Sign up</a></div>
    </div>
  </div>
